...
face[0] = {
  ...
  init: function(){
    ...
    this.cli=-1;this.bt=-1;this.gb=-1;this.hid=-1;this.atc=-1;this.bri=-1;this.acc=-1;this.dnd=-1;this.sys=1;this.btn2=1;this.slm=-1;this.hrm=-1;
...
//settings
      ...
      //heart
      if (this.btn2 || set.def.hrm!=this.hrm) {
        this.hrm=set.def.hrm;
        if (this.btn2) {
          this.btn2=0;
          g.setColor(0);
        ...
        } this.btn(this.hrm,80,0,155,75,require("heatshrink").decompress(atob("")),94,15);
  ...
  if (set.tor==1){
    ...
    if(x<77&&y<75){//btn1
      if (face[0].btSet) {
        ...
        face[0].gb=-1;face[0].cli=-1;face[0].bt=-1;face[0].hid=-1;face[0].atc=-1;face[0].bri=-1;face[0].acc=-1;face[0].dnd=-1;face[0].sys=1;this.btn2=1;face[0].slm=-1;face[0].hrm=-1;
        ...
        face[0].gb=-1;face[0].cli=-1;face[0].bt=-1;face[0].hid=-1;face[0].atc=-1;face[0].bri=-1;face[0].acc=-1;face[0].dnd=-1;face[0].sys=1;face[0].btn2=1;face[0].slm=-1;face[0].hrm=-1;
      }
